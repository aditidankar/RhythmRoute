"""
This code does not work because it generates trajectories for the entire song, but with only 150 frames.
It should generate the full trajectory for the total duration of the song.
"""
